...
public class MenuFragmentDirections private constructor() {
  private data class ActionMenuToDetail(
    public val dish: Dish,
  ) : NavDirections {
    public override val actionId: Int = R.id.action_menu_to_detail
  ...
  public companion object {
    public fun actionMenuToDetail(dish: Dish): NavDirections = ActionMenuToDetail(dish)
  }
}
